package com.miso.thegame.gameMechanics.levels;
...
public class NewLevelActivity extends Activity {
        ...
        private void createGameView() {
                setContentView(new GamePanelSingleplayer(this, this.playerType, this.buttonsTypeData, getIntent().getIntExtra("Level", 1)));
        }
}
